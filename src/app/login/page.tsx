...
import { createUser } from '@/app/actions/user.actions'; // Ensure this is correct
...
export default function SignupPage() {
  ...
  const handleGoogleSignup = async () => {
    try {
      ...
      toast({ title: 'Signup Failed', description: 'Unable to sign in with Google', variant: 'destructive' });
    }
  };
  ...
  const handleProfileSubmit = async (formData: {
    ...
    try {
      ...
      toast({ title: 'Profile Created', description: 'Welcome to CardFeed!' });
      router.push("/");
      window.location.reload()

    } catch (error) {
      console.error('Profile creation failed:', error);
      toast({ title: 'Error', description: 'Could not complete your profile.', variant: 'destructive' });
    } finally {
