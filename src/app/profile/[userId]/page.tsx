...
export default function UserProfilePage() {
  ...
  const form = useForm<ProfileFormValues>({
    ...
    defaultValues: {
      ...
      description: '',
      profileImageUrl: '',
      socialLinks: { twitter: '', linkedin: '', github: '', instagram: '', website: '' },
    },
  });
  ...
  const onSubmit: SubmitHandler<ProfileFormValues> = async (data) => {
    ...
    try {
      ...
      if (updatedUser) {
        ...
        form.reset(data); // Reset with the new data to mark the form as not dirty
      } else {
            ...
            <section className="w-full">
              ...
              {isLoadingPosts ? (
                ...
                <p className="text-center text-muted-foreground py-8">
                  {profileUser.firstName} has not posted anything publicly yet.
                </p>
              )}
            </section>
          </div>
